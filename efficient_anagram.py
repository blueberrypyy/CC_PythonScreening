...
# This is an interactive program that is designed to take an input of two words 
# and determine if the two words are an anorgram or not. The program can also 
# recognize if the string contains whitespace or not. It can be used with either 
# the default test data, or take words from user input. 
